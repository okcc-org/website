      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <AnimatedSection className="mb-8">
          <div className="max-w-5xl mx-auto">
            <div className="bg-white border border-gray-300 shadow-[0px_1px_2px_0px_rgba(0,0,0,0.20)] shadow-[0px_0.10000000149011612px_0.30000001192092896px_0px_rgba(0,0,0,0.10)] p-4 flex items-center gap-4">
              ...
              />
              <button className="bg-red-800 text-white px-6 py-2 rounded text-lg font-bold hover:bg-red-900 transition">
                Find Event
              </button>
            </div>
          </div>
          ...
          <div className="flex items-center justify-start gap-6">
            <div className="flex items-center gap-4">
              <button className="p-2 hover:bg-gray-100 transition flex items-center justify-center">
                <div className="w-0 h-0 border-l-0 border-r-[10px] border-r-black border-t-[8px] border-t-transparent border-b-[8px] border-b-transparent"></div>
              </button>
              <button className="p-2 hover:bg-gray-100 transition flex items-center justify-center">
                <div className="w-0 h-0 border-l-[10px] border-l-black border-r-0 border-t-[8px] border-t-transparent border-b-[8px] border-b-transparent"></div>
              </button>
            </div>
            <button className="w-36 h-12 border border-black rounded bg-white hover:bg-black hover:text-white transition text-black text-lg font-normal">
              Today
            </button>
